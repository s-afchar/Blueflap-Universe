...
Namespace Global.Blueflap
    ...
    Partial Public Class App
        ...
        Private _provider As Global.Blueflap.Blueflap_XamlTypeInfo.XamlTypeInfoProvider
        ...
        Public Function GetXamlType(type as Global.System.Type) As Global.Windows.UI.Xaml.Markup.IXamlType Implements Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider.GetXamlType
            If _provider Is Nothing
                _provider = new Global.Blueflap.Blueflap_XamlTypeInfo.XamlTypeInfoProvider()
            End If
...
Namespace Global.Blueflap.Blueflap_XamlTypeInfo
    ...
    Friend Class XamlTypeInfoProvider
        ...
        Private Sub InitTypeTables()
            _typeNameTable(0) = "Blueflap.Bluestart"
            _typeNameTable(1) = "Windows.UI.Xaml.Controls.Page"
            _typeNameTable(2) = "Windows.UI.Xaml.Controls.UserControl"
            _typeNameTable(3) = "Blueflap.FirstBootScreen"
            _typeNameTable(4) = "Blueflap.MainPage"
            _typeNameTable(5) = "Blueflap.MiniPlayer"
            _typeNameTable(6) = "Blueflap.Parametres"
            _typeNameTable(7) = "Blueflap.SearchFight"
            _typeNameTable(8) = "Blueflap.Verrouillage"
            _typeTable(0) = GetType(Global.Blueflap.Bluestart)
            ...
            _typeTable(3) = GetType(Global.Blueflap.FirstBootScreen)
            _typeTable(4) = GetType(Global.Blueflap.MainPage)
            _typeTable(5) = GetType(Global.Blueflap.MiniPlayer)
            _typeTable(6) = GetType(Global.Blueflap.Parametres)
            _typeTable(7) = GetType(Global.Blueflap.SearchFight)
            _typeTable(8) = GetType(Global.Blueflap.Verrouillage)
        End Sub
        ...
        Private Function Activate_0_Bluestart() As Global.System.Object
            Return New Global.Blueflap.Bluestart()
        End Function

        Private Function Activate_3_FirstBootScreen() As Global.System.Object
            Return New Global.Blueflap.FirstBootScreen()
        End Function

        Private Function Activate_4_MainPage() As Global.System.Object
            Return New Global.Blueflap.MainPage()
        End Function

        Private Function Activate_5_MiniPlayer() As Global.System.Object
            Return New Global.Blueflap.MiniPlayer()
        End Function

        Private Function Activate_6_Parametres() As Global.System.Object
            Return New Global.Blueflap.Parametres()
        End Function

        Private Function Activate_7_SearchFight() As Global.System.Object
            Return New Global.Blueflap.SearchFight()
        End Function

        Private Function Activate_8_Verrouillage() As Global.System.Object
            Return New Global.Blueflap.Verrouillage()
        End Function
        ...
        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            ...
            Case 0     ' Blueflap.Bluestart
                ...
                userType.Activator = AddressOf Activate_0_Bluestart
                userType.SetIsLocalType()
                xamlType = userType

            Case 1     ' Windows.UI.Xaml.Controls.Page
                xamlType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlSystemBaseType(typeName, type)

            Case 2     ' Windows.UI.Xaml.Controls.UserControl
                xamlType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlSystemBaseType(typeName, type)

            Case 3     ' Blueflap.FirstBootScreen
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_3_FirstBootScreen
                userType.SetIsLocalType()
                xamlType = userType

            Case 4     ' Blueflap.MainPage
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_4_MainPage
                userType.SetIsLocalType()
                xamlType = userType

            Case 5     ' Blueflap.MiniPlayer
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_5_MiniPlayer
                userType.SetIsLocalType()
                xamlType = userType

            Case 6     ' Blueflap.Parametres
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_6_Parametres
                userType.SetIsLocalType()
                xamlType = userType

            Case 7     ' Blueflap.SearchFight
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_7_SearchFight
                userType.SetIsLocalType()
                xamlType = userType

            Case 8     ' Blueflap.Verrouillage
                userType = New Global.Blueflap.Blueflap_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_8_Verrouillage
                userType.SetIsLocalType()
                xamlType = userType
        ...
        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.Blueflap.Blueflap_XamlTypeInfo.XamlMember = Nothing
            ' No Local Properties
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.Blueflap.Blueflap_XamlTypeInfo.XamlSystemBaseType
        Private _provider As Global.Blueflap.Blueflap_XamlTypeInfo.XamlTypeInfoProvider
        ...
        Public Sub New(ByVal provider As Global.Blueflap.Blueflap_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.Blueflap.Blueflap_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
